...
#
# Generated by Vivado on Thu Nov 08 20:12:05 CST 2018
...
# Script info
echo -e "inst_rom.sh - Script generated by export_simulation (Vivado v2018.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_4_1 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot inst_rom xil_defaultlib.inst_rom xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/home/shawn/Xilinx/Vivado/2018.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
